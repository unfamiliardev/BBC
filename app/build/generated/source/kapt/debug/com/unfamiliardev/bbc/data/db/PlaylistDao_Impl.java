...
public final class PlaylistDao_Impl implements PlaylistDao {
  ...
  public PlaylistDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPlaylistEntity = new EntityInsertionAdapter<PlaylistEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `playlists` (`id`,`name`,`url`,`addedAt`) VALUES (nullif(?, 0),?,?,?)";
      }
      ...
      public List<PlaylistEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new PlaylistEntity(_tmpId,_tmpName,_tmpUrl,_tmpAddedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getAllOnce(final Continuation<? super List<PlaylistEntity>> $completion) {
    final String _sql = "SELECT * FROM playlists ORDER BY addedAt DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
